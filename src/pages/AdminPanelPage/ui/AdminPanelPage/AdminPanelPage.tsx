    ...
    return (
        <div className={classNames(cls.controls, {}, [className])}>
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Категории'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
                <Button fullWidth>Создать категорию</Button>
                <Button fullWidth>Редактировать категорию</Button>
                <Button fullWidth>Удалить категорию</Button>
            </div>
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Бренды'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
            ...
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Продукт'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
            ...
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Свойства Продукта'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
            ...
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Пользователи'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
            ...
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Роли пользователя'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
                <Button fullWidth>Создать роль</Button>
                <Button fullWidth>Удалить роль</Button>
            </div>
            <div className={classNames(cls.control_group, {}, [])}>
                <Text title={'Заказы'} theme={TextTheme.BLACK} size={TextSize.L} align={TextAlign.CENTER}
                      className={cls.title}/>
